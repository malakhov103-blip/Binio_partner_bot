...
def listing_description_length_rules(raw_text):
    ...
    if (
        ...
        return (
            ...
            "сделай компактным, примерно 25-33 слова. Это ограничение относится только к вводному описанию, "
    ...
    return (
        ...
        "описания — 25-33 слова. Если исходник короче, не растягивай описание до 25 слов и не добавляй фразы "
...
- Объём только вводного описания выбирай по количеству фактов. Обычно это 1-4 связных предложения, не больше 33 слов; если исходник короткий, описание должно быть короче этого ориентира. Разделы с локацией, финансами и условиями в эти слова не входят.
